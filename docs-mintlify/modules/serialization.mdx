...
{/* _Source: [python/examples/serialization/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/base.py)_ */}
...
{/* _Source: [python/examples/serialization/memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/memory.py)_ */}
...
{/* _Source: [python/examples/serialization/customExternal.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/customExternal.py)_ */}
...
{/* _Source: [python/examples/serialization/customInternal.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/customInternal.py)_ */}
...
{/* _Source: [python/examples/serialization/context.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/context.py)_ */}
