...
_Source: [python/examples/emitter/matchers.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/emitter/matchers.py)_
...
_Source: [python/examples/emitter/piping.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/emitter/piping.py)_
...
_Source: [python/examples/emitter/agentMatchers.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/emitter/agent_matchers.py)_
...
_Source: [python/examples/emitter/advanced.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/emitter/advanced.py)_
