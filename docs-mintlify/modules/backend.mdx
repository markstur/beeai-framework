...
<Note>
Explore the implementation in the [Python](https://github.com/i-am-bee/beeai-framework/tree/main/python/beeai_framework/backend) or
...
const chatModel = await ChatModel.fromName("ollama:granite3.2:8b");
```
</CodeGroup>
...
const chatModel = new OllamaChatModel("llama3.1");
```
</CodeGroup>
