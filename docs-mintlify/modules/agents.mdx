...
For practical examples, check out the [Python](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents) or [Typescript](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/agents) agent examples directories.
...
Control how the agent runs by configuring retries, timeouts, and iteration limits.
  ...
  <CodeGroup>
    ...
    ``` 
    ```ts TypeScript
    // typescript/examples/agents/react.ts
    ```
  </CodeGroup>
