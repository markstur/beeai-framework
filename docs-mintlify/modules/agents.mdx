...
An AI agent is a sophisticated system built on top of large language models (LLMs) that can solve complex problems through structured reasoning and autonomous actions. Unlike simple chatbots that only respond to individual prompts, agents possess several key capabilities:
...
- 🔍 Revise their approach based on feedback

These capabilities enable agents to autonomously navigate complex problem-solving scenarios, making decisions and adjusting their strategies as needed. This makes them particularly valuable for tasks that require planning, research, data analysis, and multi-step execution.
...
<Note>
  Location within the framework: [beeai_framework/agents](https://github.com/i-am-bee/beeai-framework/tree/python/beeai_framework/agents).
</Note>
...
The RemoteAgent facilitates communication with remote agents through API endpoints. It allows you to send prompts to agents, receive responses, and manage the agent’s state via an asynchronous interface. This enables integration with external agents hosted on remote servers, eliminating the need to host or run agents locally.

RemoteAgent can be utilized to build multi-agent systems by interacting with multiple agents via different API endpoints. You can integrate several agents into a single application, each exposing its functionality through its respective remote API.
...
The StreamlitAgent is designed for building interactive web applications with Streamlit integration. It can generate rich UI components dynamically.

<CodeGroup>

{/* <!-- embedme python/examples/agents/experimental/streamlit.py --> */}
```py Python
```

{/* <!-- embedme typescript/examples/agents/experimental/streamlit.ts --> */}
```ts TypeScript
```
...
[_Source: examples/agents/simple.py_](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/simple.py)
...
<Tip>
  See the [tools documentation](/python/modules/tools.mdx) for more information on available tools and creating custom tools.
</Tip>
...
- [UnconstrainedMemory](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/unconstrained_memory.py) - For unlimited storage
- [SlidingMemory](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/sliding_memory.py) - For keeping only the most recent messages
- [TokenMemory](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/token_memory.py) - For managing token limits
- [SummarizeMemory](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/summarize_memory.py) - For summarizing previous conversations

<Tip>
  See the [memory documentation](/python/modules/memory.mdx) for more information on memory types.
</Tip>
...
<Tip>
  See the [emitter documentation](/python/modules/emitter.mdx) for more information on event observation.
</Tip>
...
[_Source: examples/memory/agent_memory.py_](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/agent_memory.py)
...
[_Source: examples/workflows/multi_agents.py_](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/multi_agents.py)

**Example Workflow Patterns:**

- [multi_agents.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/multi_agents.py) - Multiple specialized agents working together
- [memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/memory.py) - Memory-aware workflow for conversation

<Tip>
  See the [workflows documentation](/python/modules/workflows.mdx) for more information.
</Tip>
...
- All agent examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/agents).
