...
_Source: [python/examples/workflows/nesting.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/nesting.py)_
...
_Source: [python/examples/workflows/memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/memory.py)_
