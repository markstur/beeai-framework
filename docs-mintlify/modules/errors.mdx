...
_Source: [examples/errors/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/errors/base.py)_
...
_Source: [examples/errors/tool.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/errors/tool.py)_
