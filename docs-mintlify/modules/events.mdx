...
<Note>
Explore the implementation in the [Python](https://github.com/i-am-bee/beeai-framework/tree/main/python/beeai_framework/emitter) or [TypeScript](https://github.com/i-am-bee/beeai-framework/tree/main/typescript/src/emitter).
</Note>
