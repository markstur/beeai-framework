...
<Note>
Location within the framework: [beeai_framework/emitter](https://github.com/i-am-bee/beeai-framework/tree/python/beeai_framework/emitter) and [events.md](/python/modules/events.mdx).
</Note>
...
_Source: [python/beeai_framework/agents/react/events.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/agents/react/events.py)_
...
_Source: [python/beeai_framework/backend/events.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/backend/events.py)_
...
_Source: [python/beeai_framework/tools/events.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/tools/events.py)_
...
_Source: [python/beeai_framework/workflows/events.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/workflows/events.py)_
...
_Source: [python/beeai_framework/agents/tool_calling/events.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/agents/tool_calling/events.py)_
