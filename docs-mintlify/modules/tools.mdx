...
<Note>
Explore the implementation in [Python](https://github.com/i-am-bee/beeai-framework/tree/main/python/beeai_framework/tools) or
[TypeScript](https://github.com/i-am-bee/beeai-framework/tree/main/typescript/src/tools).
</Note>
...
<Tip>
Would you like to use a tool from LangChain? See the LangChain tool example in [Python](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/langchain.py).
...
{/* <!-- todo typescript/examples/tools/duckduckgo.ts --> */}
```ts TypeScript [expandable]
Example coming soon
```
...
```
{/* <!-- todo typescript/examples/tools/openmeteo.ts --> */}
```ts TypeScript [expandable]
Example coming soon
```
</CodeGroup>
...
{/* <!-- todo typescript/examples/tools/wikipedia.ts --> */}
```ts TypeScript [expandable]
Example coming soon
```
</CodeGroup>
...
{/* <!-- todo typescript/examples/tools/mcp_tool_creation.ts --> */}
```ts TypeScript [expandable]
Example coming soon
```
...
{/* <!-- todo typescript/examples/tools/python_tool.ts --> */}
```ts TypeScript [expandable]
Example coming soon
```
...
{/* <!-- todo typescript/examples/tools/custom/python.ts --> */}
```ts TypeScript [expandable]
Example coming soon
```
</CodeGroup>
