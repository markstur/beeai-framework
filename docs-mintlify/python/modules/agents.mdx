...
- [simple.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/simple.py) - Basic example of a ReAct Agent using OpenMeteo and DuckDuckGo tools
- [react.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py) - More complete example using Wikipedia integration
- [granite.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/granite.py) - Example using the Granite model
...
_Source: [examples/agents/react.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py)_
...
_Source: [examples/templates/system_prompt.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/system_prompt.py)_
...
_Source: [examples/agents/simple.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/simple.py)_
...
_Source: [examples/memory/agent_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/agent_memory.py)_
...
_Source: [examples/workflows/multi_agents.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/multi_agents.py)_
