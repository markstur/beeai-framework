...
_Source: [examples/cache/unconstrained_cache_function.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/unconstrained_cache_function.py)_
