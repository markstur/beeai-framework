...
_Source: [examples/templates/basic_template.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/basic_template.py)_
...
_Source: [examples/templates/functions.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/functions.py)_
...
_Source: [examples/templates/objects.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/objects.py)_
...
_Source: [examples/templates/arrays.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/arrays.py)_
...
_Source: [examples/templates/forking.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/forking.py)_
