...
_Source: [examples/tools/python_tool.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/python_tool.py)_
...
_Source: [examples/tools/custom/sandbox.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/custom/sandbox.py)_
