...
<Note>
**COMING SOON! 🚀 Serialization is not yet implemented in Python, but is available today in [TypeScript](/typescript/modules/serialization.mdx)**
</Note>
...
{/* _Source: [examples/serialization/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/base.py)_ */}
...
{/* _Source: [examples/serialization/memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/memory.py)_ */}
...
{/* _Source: [examples/serialization/customExternal.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/customExternal.py)_ */}
...
{/* _Source: [examples/serialization/customInternal.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/customInternal.py)_ */}
...
{/* _Source: [examples/serialization/context.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/serialization/context.py)_ */}

---

## Examples
- All serialization examples are coming soon in python.
{/* - All serialization examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/serialization). */}
