...
Please refer to the [following example](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/agents/bee_advanced.ts) to see how to modify them.

## Creating your own agent

To create your own agent, you must implement the agent's base class (`BaseAgent`).

The example can be found [here](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/agents/custom_agent.ts).
