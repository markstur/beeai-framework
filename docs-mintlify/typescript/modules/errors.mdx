...
_Source: [examples/errors/base.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/errors/base.ts)_
...
_Source: [examples/errors/tool.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/errors/tool.ts)_
