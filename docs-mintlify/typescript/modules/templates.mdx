...
_Source: [examples/templates/primitives.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/templates/primitives.ts)_
...
_Source: [examples/templates/arrays.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/templates/arrays.ts)_
...
_Source: [examples/templates/objects.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/templates/objects.ts)_
...
_Source: [examples/templates/forking.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/templates/forking.ts)_
...
_Source: [examples/templates/functions.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/templates/functions.ts)_
