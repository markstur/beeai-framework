...
_Source: [examples/emitter/base.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/emitter/base.ts)_
...
_Source: [examples/emitter/advanced.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/emitter/advanced.ts)_
...
_Source: [examples/emitter/matchers.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/emitter/matchers.ts)_
...
_Source: [examples/emitter/piping.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/emitter/piping.ts)_
...
_Source: [examples/emitter/agentMatchers.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/emitter/agentMatchers.ts)_
