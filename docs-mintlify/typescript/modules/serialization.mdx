...
_Source: [examples/serialization/base.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/base.ts)_
...
_Source: [examples/serialization/memory.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/serialization/memory.ts)_
...
_Source: [examples/serialization/customExternal.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/serialization/customExternal.ts)_
...
_Source: [examples/serialization/customInternal.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/serialization/customInternal.ts)_
...
_Source: [examples/serialization/context.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/serialization/context.ts)_
