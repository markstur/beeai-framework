...
_Source: [examples/workflows/simple.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/workflows/simple.ts)_
...
_Source: [examples/workflows/nesting.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/workflows/nesting.ts)_
...
_Source: [examples/workflows/agent.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/workflows/agent.ts)_
...
_Source: [examples/workflows/contentCreator.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/workflows/contentCreator.ts)_
...
_Source: [examples/workflows/multiAgents.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/workflows/multiAgents.ts)_
