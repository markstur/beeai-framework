...
_Source: [examples/backend/structured.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/backend/structured.ts)_
...
_Source: [examples/backend/toolCalling.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/backend/toolCalling.ts)_
