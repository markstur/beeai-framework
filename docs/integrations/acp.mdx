...
<CodeGroup>
	...
	{/* <!-- embedme python/examples/agents/providers/acp.py#L4-L9999 --> */}
	```py Python
	import asyncio
	import sys
	import traceback
	...
	{/* <!-- embedme typescript/examples/agents/providers/acp.ts#L6-L9999 --> */}
	```ts TypeScript
...
{/* <!-- embedme python/examples/serve/acp.py#L4-L9999 --> */}
```py
...
{/* <!-- embedme python/examples/serve/acp_with_custom_agent.py#L4-L9999 --> */}
```py
import sys
import traceback
