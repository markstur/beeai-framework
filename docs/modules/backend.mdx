...
{/* <!-- embedme typescript/examples/backend/providers/watsonx.ts#L6-L9999 --> */}
...
{/* <!-- embedme typescript/examples/backend/chat.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
import "dotenv/config.js";
...
{/* <!-- embedme typescript/examples/backend/chatStream.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
import "dotenv/config.js";
import { createConsoleReader } from "examples/helpers/io.js";
import { UserMessage } from "beeai-framework/backend/message";
...
{/* <!-- embedme typescript/examples/backend/providers/langchain.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
