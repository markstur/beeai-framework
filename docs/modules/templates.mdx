...
{/* <!-- embedme typescript/examples/templates/primitives.ts#L6-L9999 --> */}
...
{/* <!-- embedme typescript/examples/templates/functions.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
import { PromptTemplate } from "beeai-framework/template";
import { z } from "zod";
...
{/* <!-- embedme typescript/examples/templates/objects.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
import { PromptTemplate } from "beeai-framework/template";
import { z } from "zod";
...
{/* <!-- embedme typescript/examples/templates/arrays.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
import { PromptTemplate } from "beeai-framework/template";
import { z } from "zod";
