...
{/* <!-- comingsoon python/examples/serialization/base.py#L4-L9999 --> */}
```py Python [expandable]
Example coming soon
```

{/* <!-- embedme typescript/examples/serialization/base.ts#L6-L9999 --> */}
...
{/* <!-- comingsoon python/examples/serialization/memory.py#L4-L9999 --> */}
```py Python [expandable]
Example coming soon
```

{/* <!-- embedme typescript/examples/serialization/memory.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
...
{/* <!-- comingsoon python/examples/serialization/custom_external.py#L4-L9999 --> */}
```py Python [expandable]
Example coming soon
```

{/* <!-- embedme typescript/examples/serialization/customExternal.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
import { Serializer } from "beeai-framework/serializer/serializer";
...
{/* <!-- comingsoon python/examples/serialization/custom_internal.py#L4-L9999 --> */}
```py Python [expandable]
Example coming soon
```

{/* <!-- embedme typescript/examples/serialization/customInternal.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
...
{/* <!-- comingsoon python/examples/serialization/context.py#L4-L9999 --> */}
```py Python [expandable]
Example coming soon
```

{/* <!-- embedme typescript/examples/serialization/context.ts#L6-L9999 --> */}
```ts TypeScript [expandable]
