...
<Note>
Location within the framework: [beeai_framework/memory](https://github.com/i-am-bee/beeai-framework/tree/python/beeai_framework/memory).
</Note>
...
{/* <!-- embedme python/examples/memory/base.py#L4-L9999 --> */}
...
_Source: [/python/examples/memory/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/base.py)_

### Usage with LLMs

{/* <!-- embedme python/examples/memory/llm_memory.py#L4-L9999 --> */}
...
_Source: [/python/examples/memory/llm_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/llm_memory.py)_
...
{/* <!-- embedme python/examples/memory/unconstrained_memory.py#L4-L9999 --> */}
...
_Source: [/python/examples/memory/unconstrained_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/unconstrained_memory.py)_
...
{/* <!-- embedme python/examples/memory/sliding_memory.py#L4-L9999 --> */}
...
_Source: [/python/examples/memory/sliding_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/sliding_memory.py)_
...
{/* <!-- embedme python/examples/memory/token_memory.py#L4-L9999 --> */}
...
_Source: [/python/examples/memory/token_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/token_memory.py)_

### SummarizeMemory

Only a single summarization of the conversation is preserved. Summarization is updated with every new message.

{/* <!-- embedme python/examples/memory/summarize_memory.py#L4-L9999 --> */}
...
_Source: [python/examples/memory/summarize_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/summarize_memory.py)_
...
{/* <!-- embedme python/examples/memory/custom.py#L4-L9999 --> */}
...
_Source: [/python/examples/memory/custom.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/custom.py)_
...
- All memory examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/memory).
