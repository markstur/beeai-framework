...
{/* <!-- embedme python/examples/workflows/simple.py#L4-L9999 --> */}
...
_Source: [python/examples/workflows/simple.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/simple.py)_
...
{/* <!-- embedme python/examples/workflows/nesting.py#L4-L9999 --> */}
...
_Source: [examples/workflows/nesting.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/nesting.py)_
...
{/* <!-- embedme python/examples/workflows/memory.py#L4-L9999 --> */}
...
_Source: [examples/workflows/memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/memory.py)_
...
- All workflow examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/workflows).
