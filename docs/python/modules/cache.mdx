...
<Note>
**COMING SOON! 🚀 Cache is not yet implemented in Python, but is available today in [TypeScript](/typescript/modules/cache.mdx)**
</Note>
...
{/* <!-- embedme python/examples/cache/unconstrained_cache_function.py#L4-L9999 --> */}
...
_Source: [python/examples/cache/unconstrained_cache_function.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/unconstrained_cache_function.py)_

### Using with tools

BeeAI framework's caching system seamlessly integrates with tools:

{/* <!-- embedme python/examples/cache/tool_cache.py#L4-L9999 --> */}
...
_Source: [examples/cache/tool_cache.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/tool_cache.py)_

### Using with LLMs

You can also cache LLM responses to save on API costs:

{/* <!-- embedme python/examples/cache/llm_cache.py#L4-L9999 --> */}
...
_Source: [examples/cache/llm_cache.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/llm_cache.py)_
...
{/* <!-- embedme python/examples/cache/unconstrained_cache.py#L4-L9999 --> */}
...
_Source: [examples/cache/unconstrained_cache.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/unconstrained_cache.py)_

### SlidingCache

Maintains a maximum number of entries, removing the oldest entries when the limit is reached.

{/* <!-- embedme python/examples/cache/sliding_cache.py#L4-L9999 --> */}
...
_Source: [examples/cache/sliding_cache.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/sliding_cache.py)_
...
{/* <!-- embedme python/examples/cache/custom.py#L4-L9999 --> */}
...
_Source: [examples/cache/custom.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/cache/custom.py)_
...
{/* - All cache examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/cache). */}
