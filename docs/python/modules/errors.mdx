...
<Note>
Location within the framework: [beeai_framework/errors.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/errors.py).
</Note>
...
{/* <!-- embedme python/examples/errors/base.py#L4-L9999 --> */}
```py
...
_Source: [python/examples/errors/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/errors/base.py)_
...
<Tip>
Casting an unknown error to a `FrameworkError` can be done by calling the `FrameworkError.ensure` static method ([example](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/errors/cast.py)).
</Tip>
...
example
{/* <!-- embedme python/examples/errors/tool.py#L4-L9999 --> */}
```py
import asyncio
...
_Source: [python/examples/errors/tool.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/errors/tool.py)_
...
- All error examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/errors).
