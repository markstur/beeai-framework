...
<Note>
Location within the framework: [beeai_framework/logger](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/logger/logger.py).
</Note>
...
{/* <!-- embedme python/examples/logger/base.py#L4-L9999 --> */}
...
{/* <!-- embedme python/examples/logger/agent.py#L4-L9999 --> */}
...
- All logger examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/logger).
