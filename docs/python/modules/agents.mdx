...
_Source: [python/examples/agents/react.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py)_
...
_Source: [python/examples/agents/simple.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/simple.py)_
...
_Source: [python/examples/memory/agent_memory.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/memory/agent_memory.py)_
...
_Source: [python/examples/workflows/multi_agents.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/workflows/multi_agents.py)_
