...
<Note>
Location within the framework: [beeai_framework/backend](https://github.com/i-am-bee/beeai-framework/tree/python/beeai_framework/backend).
</Note>
---
...
<Tip>
If you don't see your provider raise an issue [here](https://github.com/i-am-bee/beeai-framework/discussions). Meanwhile, you can use [Ollama adapter](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/backend/providers/ollama.py).
</Tip>
...
{/* <!-- embedme python/examples/backend/providers/watsonx.py#L4-L9999 --> */}
...
_Source: [examples/backend/providers/watsonx.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/backend/providers/watsonx.py)_

All providers examples can be found in [examples/backend/providers](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/backend/providers).
...
{/* <!-- embedme python/examples/backend/chat.py#L4-L9999 --> */}
...
_Source: [examples/backend/chat.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/backend/chat.py)_
...
llm = OllamaChatModel("llama3.1")
user_message = UserMessage("How many islands make up the country of Cape Verde?")
response = await llm.create(messages=[user_message], stream=True).observe(
	lambda emitter: emitter.match("new_token", lambda data, event: print(data.value.get_text_content())))
)
```
...
{/* <!-- embedme python/examples/backend/structured.py#L4-L9999 --> */}
...
{/* <!-- embedme python/examples/backend/tool_calling.py#L4-L9999 --> */}
...
- All backend examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/backend).
