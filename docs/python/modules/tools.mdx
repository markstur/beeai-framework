...
<Note>
Location within the framework: [beeai_framework/tools](https://github.com/i-am-bee/beeai-framework/tree/python/beeai_framework/tools).
</Note>
...
For detailed usage examples of each built-in tool with complete implementation code, see the [tools examples directory](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/tools).

<Tip>
Would you like to use a tool from LangChain? See the [LangChain tool example](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/langchain.py).
</Tip>
...
{/* <!-- embedme python/examples/tools/base.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/base.py)_

### Advanced usage

Tools often support additional configuration options to customize their behavior:

{/* <!-- embedme python/examples/tools/advanced.py#L4-L9999 --> */}
```py
import asyncio
import sys
import traceback
...
_Source: [/python/examples/tools/advanced.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/advanced.py)_
...
{/* <!-- embedme python/examples/tools/agent.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/agent.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/agent.py)_

### Using the tool decorator

For simpler tools, you can use the `tool` decorator to quickly create a tool from a function:

{/* <!-- embedme python/examples/tools/decorator.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/decorator.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/decorator.py)_
...
{/* <!-- embedme python/examples/tools/duckduckgo.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/duckduckgo.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/duckduckgo.py)_
...
{/* <!-- embedme python/examples/tools/openmeteo.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/openmeteo.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/openmeteo.py)_
...
{/* <!-- embedme python/examples/tools/wikipedia.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/wikipedia.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/wikipedia.py)_
...
<Tip>
Check out the [MCP Slack integration tutorial](/python/tutorials.mdx#slack-integration)
</Tip>

<details>
<Summary>🌟 CLICK HERE to expand the MCP tool example</Summary>
{/* <!-- embedme python/examples/tools/mcp_tool_creation.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/mcp_tool_creation.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/mcp_tool_creation.py)_
...
<Note>
This tool requires [beeai-code-interpreter](https://github.com/i-am-bee/bee-code-interpreter) to use. Get started quickly with [beeai-framework-py-starter](https://github.com/i-am-bee/beeai-framework-py-starter).
</Note>
...
{/* <!-- embedme python/examples/tools/python_tool.py#L4-L9999 --> */}
...
_Source: [python/examples/tools/python_tool.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/python_tool.py)_
...
{/* <!-- embedme python/examples/tools/custom/sandbox.py#L4-L9999 --> */}
...
_Source: [python/examples/tools/custom/sandbox.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/custom/sandbox.py)_
...
<Note>
Initiate the [`Tool`](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/tools/tool.py) by passing your own handler (function) with the `name`, `description` and `input schema`.
</Note>
...
{/* <!-- embedme python/examples/tools/custom/base.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/custom/base.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/custom/base.py)_
...
{/* <!-- embedme python/examples/tools/custom/openlibrary.py#L4-L9999 --> */}
...
_Source: [/python/examples/tools/custom/openlibrary.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/tools/custom/openlibrary.py)_
...
- All tool examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/tools).
