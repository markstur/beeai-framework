...
<Note>
Location within the framework: [beeai_framework/template](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/template.py).
</Note>
...
{/* <!-- embedme python/examples/templates/basic_template.py#L4-L9999 --> */}
...
_Source: [python/examples/templates/basic_template.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/basic_template.py)_

### Template functions

Add dynamic content to templates using custom functions.

{/* <!-- embedme python/examples/templates/functions.py#L4-L9999 --> */}
...
_Source: [python/examples/templates/functions.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/functions.py)_

### Working with objects

Handle complex nested data structures in templates with proper type validation.

{/* <!-- embedme python/examples/templates/objects.py#L4-L9999 --> */}
...
_Source: [python/examples/templates/objects.py](https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/templates/objects.py)_

### Working with arrays

Process collections of data within templates for dynamic list generation.

{/* <!-- embedme python/examples/templates/arrays.py#L4-L9999 --> */}
...
{/* <!-- embedme python/examples/templates/forking.py#L4-L9999 --> */}
...
- All template examples can be found in [here](https://github.com/i-am-bee/beeai-framework/tree/main/python/examples/templates).
