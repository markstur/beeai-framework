...
All examples can be found [here](https://github.com/i-am-bee/beeai-framework/tree/main/typescript/examples/tools).

<Tip>
Would you like to use a tool from LangChain? See the [example](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/langchain.ts).
</Tip>
...
{/* <!-- embedme typescript/examples/tools/base.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/base.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/base.ts)_

### Advanced

{/* <!-- embedme typescript/examples/tools/advanced.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/advanced.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/advanced.ts)_
...
{/* <!-- embedme typescript/examples/tools/agent.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/agent.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/agent.ts)_

## Writing a new tool

To create a new tool, you have the following options on how to do that:

- Implement the base [`Tool`](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/src/tools/base.ts) class.
- Initiate the [`DynamicTool`](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/src/tools/base.ts) by passing your own handler (function) with the `name`, `description` and `input schema`.
- Initiate the [`CustomTool`](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/src/tools/custom.ts) by passing your own Python function (code interpreter needed).
...
{/* <!-- embedme typescript/examples/tools/custom/base.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/custom/base.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/custom/base.ts)_
...
{/* <!-- embedme typescript/examples/tools/custom/openLibrary.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/custom/openLibrary.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/custom/openLibrary.ts)_
...
{/* <!-- embedme typescript/examples/tools/custom/dynamic.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/custom/dynamic.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/custom/dynamic.ts)_
...
If you want to use the Python function, use the [`CustomTool`](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/src/tools/custom.ts).

{/* <!-- embedme typescript/examples/tools/custom/python.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/custom/python.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/custom/python.ts)_
...
3. Dynamically during execution via [`Emitter`](/typescript/modules/emitter.mdx): `myTool.emitter.on("start", ({ options }) => { options.env.MY_ENV = 'MY_VALUE'; })`.
</Tip>
...
{/* <!-- embedme typescript/examples/tools/mcp.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/tools/mcp.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/tools/mcp.ts)_
