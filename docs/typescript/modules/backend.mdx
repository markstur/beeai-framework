...
<Tip>
If you don't see your provider raise an issue [here](https://github.com/i-am-bee/beeai-framework/discussions). Meanwhile, you can use [LangChain adapter](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/backend/providers/langchain.ts).
</Tip>
...
All providers examples can be found in [examples/backend/providers](https://github.com/i-am-bee/beeai-framework/tree/main/typescript/examples/backend/providers).
...
```py Python
from beeai_framework.backend ChatModel

model = ChatModel.from_name("ollama:llama3.1")
console.log(model.provider_id); # ollama
console.log(model.model_id); # llama3.1
```
</CodeGroup>
...
{/* <!-- embedme typescript/examples/backend/structured.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/backend/structured.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/backend/structured.ts)_

### Tool Calling

{/* <!-- embedme typescript/examples/backend/toolCalling.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/backend/toolCalling.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/backend/toolCalling.ts)_
