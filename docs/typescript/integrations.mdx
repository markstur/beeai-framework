...
{/* <!-- embedme typescript/examples/integrations/langgraph.ts#L6-L9999 --> */}
...
_Source: [typescript/examples/integrations/langgraph.ts](https://github.com/i-am-bee/beeai-framework/blob/main/typescript/examples/integrations/langgraph.ts)_
